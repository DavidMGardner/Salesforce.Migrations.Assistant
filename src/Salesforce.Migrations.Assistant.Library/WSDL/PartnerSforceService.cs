...
// 
namespace Salesforce.Migrations.Assistant.Library.Partner.SforceService
{
...
public partial class SforceService : System.Web.Services.Protocols.SoapHttpClientProtocol {
    ...
    public SforceService() {
        this.Url = "https://test.salesforce.com/services/Soap/u/35.0";
    }
    ...
    /// <remarks/>
    public System.IAsyncResult BegindescribeFlexiPages(string[] flexiPages, FlexipageContext[] contexts, System.AsyncCallback callback, object asyncState) {
        return this.BeginInvoke("describeFlexiPages", new object[] {
                    flexiPages,
                    contexts}, callback, asyncState);
    }
    ...
    /// <remarks/>
    public System.IAsyncResult BegindescribeAppMenu(AppMenuType appMenuType, string networkId, System.AsyncCallback callback, object asyncState) {
        return this.BeginInvoke("describeAppMenu", new object[] {
                    appMenuType,
                    networkId}, callback, asyncState);
    }
    ...
    /// <remarks/>
    public System.IAsyncResult BegindescribePathAssistants(string sObjectType, string picklistValue, string[] recordTypeIds, System.AsyncCallback callback, object asyncState) {
        return this.BeginInvoke("describePathAssistants", new object[] {
                    sObjectType,
                    picklistValue,
                    recordTypeIds}, callback, asyncState);
    }
    ...
    /// <remarks/>
    public DescribePathAssistant[] EnddescribePathAssistants(System.IAsyncResult asyncResult) {
        object[] results = this.EndInvoke(asyncResult);
        return ((DescribePathAssistant[])(results[0]));
    }
    ...
    /// <remarks/>
    public System.IAsyncResult BeginrenderEmailTemplate(RenderEmailTemplateRequest[] renderRequests, System.AsyncCallback callback, object asyncState) {
        return this.BeginInvoke("renderEmailTemplate", new object[] {
                    renderRequests}, callback, asyncState);
    }
    
    /// <remarks/>
    public RenderEmailTemplateResult[] EndrenderEmailTemplate(System.IAsyncResult asyncResult) {
        object[] results = this.EndInvoke(asyncResult);
        return ((RenderEmailTemplateResult[])(results[0]));
    }
