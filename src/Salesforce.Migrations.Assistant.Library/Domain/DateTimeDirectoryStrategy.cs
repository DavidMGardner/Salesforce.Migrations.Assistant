...
namespace Salesforce.Migrations.Assistant.Library.Domain
{
    public class FlatDirectoryStrategy : IPersistenceStrategy
    {
        ...
        public FlatDirectoryStrategy(string outputLocation)
        {
        ...
        {
            _outputDirectory = String.Format("{0}\\{1}\\package", Context.OutputLocation, _outputLocation);
            _packageDirectory = String.Format("{0}\\{1}", Context.OutputLocation, _outputLocation);
    ...
    public class NoPullStrategy : IPersistenceStrategy
    {
        public SalesforceContext Context { get; set; }
        public void Save(List<SalesforceFileProxy> filesToSave)
        {
